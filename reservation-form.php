...
<form class="form-reservation-input" action="planning.php" method="post">
    <div class="form_element">
        ...
        <input type="text" name="titre" id="titre" value="" required placeholder="Titre" maxlength="30"><br><br>
    </div>
    <div class="form_element">
        <label for="description">Description</label>
        <input type="text" name="description" id="description" value="" required placeholder="Description" maxlength="30"><br><br>
    </div>
    <div class="form_element">
        <div class="">
